...
//             dd($request->types);
            ...
            //Setting Footer Payment Method Image Update
            if ($request->file('footer_payment_image')) {
                $footerPayment = $request->file('footer_payment_image');
                $footerPayment_save = time().$footerPayment->getClientOriginalName();
                $footerPayment->move('upload/setting/logo/',$footerPayment_save);
                $save_url_footerPayment_save = 'upload/setting/logo/'.$footerPayment_save;

                $setting = Setting::where('name', 'footer_payment_image')->first();
                try {
                    if(file_exists($setting->value)){
                        unlink($setting->value);
                    }
                ...
                $setting->value = $save_url_footerPayment_save;
