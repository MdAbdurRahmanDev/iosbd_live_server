...
Route::prefix($prefix)->middleware('admin')->group(function(){
    ...
    //     Route::get('supplier/pdf', [SupplierController::class, 'supplierPdf'])->name('supplier.pdf');
	// });
	...
	Route::prefix('product')->group(function(){
        ...
        //category wish specificatiion
        Route::get('/category/features/{id}', [ProductController::class, 'getCategoryFeatures'])->name('category.features');
		//category wish specification edit
        Route::get('/category/specification/get', [ProductController::class, 'getCategoryFeaturesEdit'])->name('category.features.edit');
	...
	/*================  Ajax Brand Store ==================*/
	Route::post('/supplier/insert',[ProductController::class,'supplierInsert'])->name('supplier.ajax.store');
...
Route::middleware('adminAccess')->group(function(){
    ...
    // Route::get('/customers/pdf', [UserController::class, 'downloadPDF'])->name('customers.pdf');
	...
	Route::get('/instagram-gallery', [BannerController::class, 'instagram'])->name('banner.instagram.index');
	Route::get('/instagram-gallery/create', [BannerController::class, 'instagramCreate'])->name('banner.instagram.create');
	Route::get('/instagram-gallery/edit/{id}', [BannerController::class, 'instagramEdit'])->name('banner.instagram.edit');
	...
	Route::prefix('orders')->group(function(){
		...
		Route::post('/order_ship/{id}', [OrderController::class, 'shipOrder'])->name('admin.order.ship');
		Route::post('/orders_delete/{id}', [OrderController::class, 'destroy'])->name('delete.orders');
	...
	// 	// Orders All Route
	// 	Route::get('/all_stocks', [StockController::class, 'index'])->name('all_stocks.index');
	// 	Route::get('/all_stocks/{id}/show', [StockController::class, 'show'])->name('all_stocks.show');

	// 	Route::post('/stocks_delete/{id}', [StockController::class, 'destroy'])->name('delete.stocks');
	// 	Route::post('/stocks_update/{id}', [StockController::class, 'update'])->name('admin.stocks.update');
	// 	Route::get('/invoice/{id}', [StockController::class, 'invoice_download'])->name('invoice.download');
	// });
    ...
    Route::post('/message/delete/{id}',[UserMessageController::class,'destroy'])->name('messages.delete');
