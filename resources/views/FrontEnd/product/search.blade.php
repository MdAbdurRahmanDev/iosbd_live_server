...
{{--                            <div class="badge bg-info text-white position-absolute ft-regular ab-left text-upper">New</div>--}}
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{route('product.details', $product->slug)}}"><img class="card-img-top bg-white" src="{{asset($product->product_thumbnail)}}" alt="..."></a>
                            ...
                            <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <div class="text-left mb-1">
                                        ...
                                        <!--        </div>-->
                                        <!--    </div>-->
                                        <!--    <span class="small">({{ $review_count>1 ? $review_count.' Reviews' : $review_count.' Review' }})</span>-->
                                        <!--</div>-->
    ...
    <section class="out-of-stock container mt-2">
        <h4 class="text-center text-danger py-5">Out of Stock Products</h4>
        ...
        <div class="row row-cols-2 row-cols-md-3 row-cols-lg-6 g-2">
            @if(count($outOfstock_products) > 0)
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{ route('product.details', $product->slug) }}">
                                        <img class="card-img-top" src="{{ asset($product->product_thumbnail) }}" alt="...">
                                    </a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                                <div class="text-left">
                                    <h5 class="product_name fs-md mb-0 lh-1 mb-1">
                                    ...
                                    <div class="bg-danger text-white out_of_stock text-center p-1 mt-2">
                                        Out of Stock
                                    </div>
                                </div>
                            </div>
                ...
                @endforeach
            @else
                <p class="text-center text-muted">No out-of-stock products found.</p>
            @endif
        </div>
    </section>
    @endif
