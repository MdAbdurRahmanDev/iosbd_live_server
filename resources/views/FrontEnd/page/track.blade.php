                            ...
                            <div class="order-tracking">
                                <div class="invoice-header">
                                    ...
                                    <div class="progress-container">
                                        @php
                                            $progressWidth = match($order->delivery_status) {
                                                'pending' => '20%',
                                                'processing', 'waiting' => '58%',
                                                'delivered' => '96%',
                                                default => '0%',
                                            };
                                        @endphp
                                        ...
                                        <div class="progressing">
                                            <div class="circle @if(in_array($order->delivery_status, ['pending', 'processing', 'waiting', 'delivered'])) active @endif">
                                                <i class="fa fa-check"></i>
                                            </div>
                                            <span class="progress-size">Pending</span>
                                        </div>

                                        {{-- Processing Status (includes 'processing' and 'waiting') --}}
                                        <div class="progressing">
                                            <div class="circle @if(in_array($order->delivery_status, ['processing', 'waiting', 'delivered'])) active @endif">
                                                <i class="fa fa-check"></i>
                                            </div>
                                        ...
                                        @if ($order->delivery_status == 'cancelled')
                                            <div class="progressing">
                                                <div class="circle active" style="background-color: red; border-color: red;">
