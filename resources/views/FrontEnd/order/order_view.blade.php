                                    ...
                                    <table class="table table-striped invoice-table">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right f-w-600">{{ $order->grand_total ?? ' '}}</td>
                                                </tr>
                                        </tbody>
                                    </table>
                                </div>
                                        ...
                                        <div class="tm_right_footer">
                                            <table class="tm_mb15 tm_m0_md">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_medium">৳{{ number_format($order->sub_total) }}</td>
                                                </tr>
                                                <tr>
                                                    <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Shipping Charge:</td>
                                                    <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0"> ৳{{ number_format($order->shipping_charge) }}</td>
                                                </tr>
                                                @if ($order->coupon)
                                                <tr>
                                                    <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Applied Coupon:</td>
                                                    <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0"> <i>{{ $order->coupon }}</i></td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Discount:</td>
                                                    <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0"> ৳{{ number_format($order->discount) }}</td>
                                                </tr>
                                                <tr class="tm_accent_border_20 tm_border">
                                                    ...
                                                    <td
                                                        class="tm_width_3 tm_bold tm_f16 tm_border_top_0 tm_accent_color tm_text_right tm_accent_bg_10">৳{{ number_format($order->grand_total) }}</td>
                                                </tr>
                                                </tbody>
                                            </table>
