...
<div class="tm_invoice tm_style2 tm_type1 tm_accent_border tm_radius_0 tm_small_border" id="tm_download_section">
    <div class="tm_invoice_in">
        <table style="width: 600px" style="border: none !important">
            <tr style="border: none !important">
                @php
                    $logo = get_setting('site_favicon');
                @endphp
                <td width="150px" style="z-index: 2 !important">
                    <div class="tm_logo" style="left: 5px; top: 1px;">
                        @if($logo != null)
                            <img src="{{asset($logo->value)}}"  alt="{{ env('APP_NAME') }}" style="max-width: 200px !important;">
                        @else
                ...
                <td width="150px" style="border: none !important">
                    <div class="tm_text_center">
                        <p class="tm_accent_color tm_mb0">
                            <img src="{{ asset('invoice/img/email.png') }}" style="max-width: 24px !important;" alt="Email">
                        </p>
                ...
                <td width="150px">
                    <div class="tm_text_center">
                        <p class="tm_accent_color tm_mb0">
                            <img src="{{ asset('invoice/img/phone.png') }}" style="max-width: 24px !important;" alt="Phone">
                        </p>
                ...
                <td width="150px">
                    <div class="tm_text_center">
                        <p class="tm_accent_color tm_mb0">
                            <img src="{{ asset('invoice/img/location.png') }}" style="max-width: 24px !important;" alt="Location">
                        </p>
                        {{ get_setting('business_address')->value ?? ''}}
                    </div>
                    <div class="tm_shape_bg tm_accent_bg_10 tm_border tm_accent_border_20" style="width: 35%"></div>
                </td>

            </tr>
        </table>
        <table width="600" style="border: none !important">
            <tr style="border: none !important">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td class="tm_width_7 tm_border_left tm_accent_border_20">
                                ...
                                <br>
                                City: {{ ucwords($order->upazilla->name_en ?? 'Null' ) }}, {{ ucwords($order->district->district_name_en ?? 'Null') }},
        ...
        <div class="tm_table tm_style1">
            ...
            <div class="tm_invoice_footer tm_mb15 tm_m0_md">
                <div class="">
                    <table class="tm_mb15 tm_m0_md" style="border:none !important; margin-top: 20px;">
                        <tbody>
                            <tr>
                                <td colspan="3" class="tm_border_none " style="padding: 3px 10px !important; line-height: 0.55rem !important;">
                                        <p class="tm_mb6"><b class="tm_primary_color">Payment info:</b></p>
                                        <p class="tm_m0">
                                            Payment Method: Cash On Delivery
                                            <br/>Payment Status: Unpaid
                                        </p>
                                </td>
                                <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0" style="padding: 3px 10px !important; line-height: 1.7rem !important;">
                                    <span><b>Subtotal:</b></span><br/>
                                    <span><b>Shipping Charge:</b></span>
                                     @if ($order->coupon)
                                    <br/><span><b>Applied Coupon:</b></span>
                                    @endif
                                    <br/><span><b>Discount:</b></span>
                                </td>
                                <td colspan="2" class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0" style="padding: 3px 10px !important; line-height: 1.2rem !important;"><span></span>
                                    <span><span style="font-family: Noto Sans Bengali">৳</span>{{$order->sub_total}}</span><br/>
                                    <span><span style="font-family: Noto Sans Bengali">+ ৳</span>{{ $order->shipping_charge ?? '0' }}</span>
                                    @if ($order->coupon)
                                    <br><span><span style="font-family: Noto Sans Bengali"></span><i>{{ $order->coupon }}</i></span>
                                    @endif
                                    <br/><span><span style="font-family: Noto Sans Bengali">- ৳</span>{{ $order->discount ?? '0' }}</span>
                                </td>
                            </tr>
                            ...
                            <tr class="tm_border_none" style="border:none !important;">
                                ...
                                <td class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_accent_bg_10" style="border:none !important;">Grand
                                    Total: </td>
                                <td colspan="2"
                                    class="tm_width_3 tm_bold tm_f16 tm_accent_color tm_text_right tm_accent_bg_10" style="border:none !important;">
                                    <span style="font-family: Noto Sans Bengali; font-weight: normal">৳</span> {{$order->grand_total}}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <table>
        <tbody>
            <tr style="padding-top: 100px">
                <td style="margin-right: 10px !important; width: 60%">
                    <p class="tm_m0 tm_f18 tm_accent_color tm_mb5">Thank you for your shopping.</p>
                    <p class="tm_m0 tm_f12"><strong>N.B:</strong> This invoice is system generated by <span class="tm_danger_color">{{get_setting('business_name')->value}}</span> and is valid without any signature and seal.</p>
                </td>
                <td align="right" style="margin-left: 30px">
                    ...
                    <div style="display: inline; align-items: center">
                        @if($logo != null)
                            <a href="{{ env('APP_URL') }}"><img src="{{ asset($logo->value) }}" style="max-width: 30%; margin-bottom: -5px;" alt="{{ env('APP_NAME') }}"></a>
                        @else
                            <a href="{{ env('APP_URL') }}"><img src="{{ asset('upload/no_image.jpg') }}" alt="{{ env('APP_NAME') }}"></a>
                        @endif
                    </div>
                </td>
            </tr>
