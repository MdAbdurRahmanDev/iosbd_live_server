...
<aside class="navbar-aside" id="offcanvas_aside" style="background-color: #365486">
    <div class="aside-top">
        <a href="{{ route('admin.dashboard') }}" class="brand-wrap" >
            ...
            @endphp
            @if($logo != null)
                <img src="{{ asset(get_setting('site_footer_logo')->value ?? ' ') }}" alt="{{ env('APP_NAME') }}"  style="height: 40px !important;">
            @else
...
{{--            </li>--}}
            ...
            @if(Auth::guard('admin')->user()->role == '1')
            <li class="menu-item has-submenu {{ ($route == 'subscribers.index') ? 'active' : '' }}">
                <a class="menu-link" href="#">
                    <i class="icon material-icons md-pie_chart"></i>
                    <span class="text">Subscribers</span>
                </a>
                <div class="submenu">
                    <a class="{{ ($route == 'subscribers.index') ? 'active' : '' }}" href="{{ route('subscribers.index') }}">Subscribers List</a>
                </div>
            </li>
            @endif
...
{{--            </li>--}}
            ...
            @if(Auth::guard('admin')->user()->role == '1')
                <li class="menu-item has-submenu
                {{ ($route == 'banner.instagram.index')? 'active':'' }}
                {{ ($route == 'banner.instagram.edit')? 'active':'' }}
                {{ ($route == 'banner.instagram.create')? 'active':'' }}
            ">
                    <a class="menu-link" href="#">
                        <i class="fa fa-brands fa-instagram fontawesome_icon_custom"></i>
                        <span class="text">Instagram Gallery</span>
                    </a>
                    <div class="submenu">
                        <a class="{{ ($route == 'banner.instagram.index') ? 'active':'' }}" href="{{ route('banner.instagram.index') }}">Gallery List</a>
                        <a class="{{ ($route == 'banner.instagram.create') ? 'active':'' }}" href="{{ route('banner.instagram.create') }}">Gallery Add</a>
                    </div>
                </li>
            @endif
