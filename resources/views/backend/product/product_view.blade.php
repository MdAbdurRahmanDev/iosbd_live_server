...
{{--                            <td> {{ $item->name_bn ?? 'NULL' }} </td>--}}
                            ...
                            <td >
                                <div class="btn-group" style="margin: 50% 0">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('product.duplicate',$item->id) }}" title="Duplicate"
                                       style="padding:12px; margin-right: 5px; border-radius: 5px"><i class="fa fa-copy"></i></a>
