			...
			<form method="post" action="{{ route('product.update',$product->id) }}" enctype="multipart/form-data">
		        	...
		        	<div class="card-body">
		        		<div class="row">
		                	<div class="col-md-12 mb-4">
		                        ...
		                        <input class="form-control" id="product_name_en" type="text" name="name_en" required placeholder="Write product name english" value="{{ $product->name_en }}">
		                        @error('name_en')
		                            <p class="text-danger">{{$message}}</p>
		                        @enderror
		                    </div>
                            <div class="col-md-6 mb-4">
		                        <label for="product_code" class="col-form-label" style="font-weight: bold;">Product Code <span class="text-danger">*</span></label>
		                        <input class="form-control" id="product_code" type="text" name="product_code" required placeholder="Write product code" value="{{ $product->product_code }}">
		                        @error('product_code')
		                            <p class="text-danger">{{$message}}</p>
		                        @enderror
		                    </div>
		        ...
		        <div class="card">
		        	...
		        	<div class="card-body">
		        		<div class="row">
		        			<div class="col-md-6 mb-4">
	                          	<label for="bying_price" class="col-form-label" style="font-weight: bold;">Product Totla Cost:</label><span class="text-danger">*</span>
...
{{--                            @endif--}}
		        		...
		        		<div class="row">
                            ...
                            <div class="col-md-6 mb-4">
		                        <label for="low_stock" class="col-form-label" style="font-weight: bold;">Low Stock <span class="text-danger">*</span></label>
		                        <input class="form-control" id="low_stock" type="number" name="low_stock" required placeholder="Write product low stock" value="{{$product->low_stock}}">
		                        @error('low_stock')
		                            <p class="text-danger">{{$message}}</p>
		                        @enderror
		                    </div>
						...
						<div class="col-md-12 mb-3">
		                	...
		                	<div class="box bt-3 border-info">
					         	<div class="row row-sm">
						            ...
						            <div class="col-md-3">
						               <div class="card">
						                  <img src="{{ asset($img->photo_name) }}" class="showImage{{$img->id}}" style="width: 280px;">
						                  	<div class="card-body">
						                     <h5 class="card-title">
		        ...
		        <!-- card -->
				    ...
				    {{-- Dynamic Feature Fields --}}
						<div class="card" style="" id="feature_id">
							<div class="card-body">
								<div class="row">
									<div class="col-md-12 mb-4">
										<div id="feature-fields-container" class="col-md-12 mb-4" style="">
	...
	$(document).ready(function() {
		$('#product_category').on('change', function() {
			...
			$.ajax({
				...
				url: "{{ route('category.features.edit') }}",
				data: { 
					p_id: {{$product->id}},
					c_id: categoryId
