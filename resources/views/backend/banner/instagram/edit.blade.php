    ...
    <div class="row">
        <div class="col-md-8 offset-2">
            <div class="content-header">
                <h2 class="content-title">Edit Gallery</h2>
                <div class="">
                    <a href="{{route('banner.instagram.index') }}" class="btn btn-primary p-3" title="Category List"><i class="fa fa-list"></i></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                           ...
                           <div class="mb-2 col-sm-6">
                                <img id="showImage" class="rounded avatar-lg mb-3" src="{{ asset($banner->banner_img) }}" alt="Intagram image" width="100px" height="100px;">
                           </div>
                            <div class="col-sm-12 mb-4">
