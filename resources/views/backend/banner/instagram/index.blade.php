...
<section class="content-main">
    <div class="content-header">
        <div class="col-md-10">
            <h2 class="content-title">Instagram Gallery</h2>
            <strong style="font-weight: bold" class="text-dark"> {{ count($banners) }} Item(s) Found </strong>

        </div>
        <div class="col-md-2">
            <a href="{{ route('banner.instagram.create') }}" class="btn btn-primary" title="Add Banner"><i class="material-icons md-plus"></i></a>
        </div>
            ...
            <div class="table-responsive-sm">
                <table id="example" class="table table-bordered table-striped" width="100%">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class=" btn-group" style="margin: 25% 0">
                                        <a href="{{ route('banner.instagram.edit', $banner->id) }}" class="btn btn-primary" title="Edit"
                                        ...
                                        {{-- <a href="{{ route('banner.delete',$banner->id) }}" id="delete" class="btn btn-danger" title="Delete"
                                           ...
                                           <form action="{{ route('banner.delete', $banner->id) }}" method="GET" class="delete-form" style="display: inline;">
                                            @csrf
                        ...
                        @else
                            <tr>
                                <td class="text-center" colspan="5">No item added!</td>
                            </tr>
                        @endif
                    </tbody>
                </table>
