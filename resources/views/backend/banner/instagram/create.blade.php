    ...
    <div class="row">
        <div class="col-md-8 offset-2">
            <div class="content-header">
                <h2 class="content-title">Add Instagram Gallery Item</h2>
                <div class="">
                    <a href="{{route('banner.instagram.index') }}" class="btn btn-primary p-3" title="Gallery List"><i class="fa fa-list"></i></a>
                </div>
            </div>
        </div>
    </div>
		        	...
		        	<div class="card-body">
		        		<div class="row">
                            ...
                            <div class="col-sm-12 mb-4 ">
	                          	<label for="banner_url" class="col-form-label" style="font-weight: bold;">Post Url:</label>
	                        ...
	                        <div class="col-sm-6 mb-4 d-none">
	                            ...
	                            <div class="custom_select">
                                    <select class="form-control select-active w-100 form-select select-nice" name="position" required>
                                        <option value="4" selected>Instagram Gallery</option>
                                    </select>
                                </div>
                            </div>
	                       <div class="mb-2 col-sm-6">
	                       		<img id="showImage" class="rounded avatar-lg mb-3" src="{{ (!empty($editData->profile_image))? url('upload/admin_images/'.$editData->profile_image):url('upload/no_image.jpg') }}" alt="Instagram image" width="100px" height="100px;">
	                       </div>
	                        <div class="col-sm-12 mb-4">
	                         	<label for="image" class="col-form-label" style="font-weight: bold;">Photo (190x190 px):</label>
