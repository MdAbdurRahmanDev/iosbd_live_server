                            ...
                            <div class="col-md-12">
                                <form method="post" action="{{ route('category.update', $category->id) }}"
                                    ...
                                    <div class="mb-4">
                                        <div class="demo-checkbox">
                                            <input type="checkbox" id="md_checkbox_29" class="form-check-input cursor"
                                                name="category_tab" {{ $category->category_tab == 1 ? 'checked' : '' }}
                                                value="1">
                                            <label for="md_checkbox_29" class="form-check-label cursor"
                                    ...
                                    <div class="mb-4">
                                        <div class="col-md-6 col-xl-6 col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <button name="add_name" id="add_name" class="add_name_btn"
                                                    type="button">
                                                    <table class="table table-bordered table-hover" id="dynamic_field">
                                                         <tr>
                                                            <td colspan="2">
                                                                <button type="button" name="add" id="add"
                                                                    class="btn btn-primary">Add Specification Field</button>
                                                            </td>
                                                        </tr>
                                                    {{--
                                                        @php
                                                            $features = $category->featured
                                                                ? explode(',', $category->featured)
                                                                : [];
                                                        @endphp
                                                    --}}
                                                        @foreach ($specifications as $index => $specification)
                                                            <tr id="row{{ $index }}">
                                                                <td>
                                                                    ...
                                                                    <input type="hidden" value="{{$specification->id}}" name="specification_id[]"/>
                                                                </td>
                                                                <td>
        ...
        $(document).ready(function() {
            ...
            $("#add").click(function() {
                ...
                $('#dynamic_field').append(
                    '<tr id="row' + i + '">' +
                    '<td><input type="text" name="featured[]" placeholder="Enter Feature" class="form-control name_list"/></td>' +
