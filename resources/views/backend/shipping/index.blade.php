                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <a href="{{ route('shipping.edit', $shipping->id)}}" class="btn btn-primary" title="Edit"
                                ...
                                <form action="{{ route('shipping.delete', $shipping->id) }}" method="GET" class="delete-form" style="display: inline;">
                                    @csrf
